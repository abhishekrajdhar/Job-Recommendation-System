...
st.title("📄AI for Job Recommendation")
...
if uploaded_file:
    ...
    with st.spinner("Summarizing your resume..."):
        summary = ask_genai(f"Summarize this resume highlighting the skills, edcucation, and experience: \n\n{resume_text}", max_tokens=500)

    
    with st.spinner("Finding skill Gaps..."):
        gaps = ask_genai(f"Analyze this resume and highlight missing skills, certifications, and experiences needed for better job opportunities: \n\n{resume_text}", max_tokens=400)
    ...
    if st.button("🔎Get Job Recommendations"):
        ...
        st.markdown("---")
        st.header("💼 Top Indeed Jobs (India)")
